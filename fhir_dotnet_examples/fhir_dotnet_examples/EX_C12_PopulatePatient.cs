...
{
  class EX_C12_PopulatePatient : fhir_dot_net_examplese
    {
        ...
        public void Execute()
        {
          /*
            ...
            */
            ...
            try
            {
                var TaskPatientCreated=client.CreateAsync<Patient>(p,conditions);
                PatientCreated=TaskPatientCreated.GetAwaiter().GetResult();
            }
            ...
            try
            {
                var TObservationCreated = client.CreateAsync<Observation>(o);
                Observation ObservationCreated = TObservationCreated.GetAwaiter().GetResult();
